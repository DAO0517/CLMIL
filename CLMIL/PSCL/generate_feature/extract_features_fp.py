...
import argparse
from utils.utils import collate_features_with_path, collate_features
...
parser.add_argument('--data_dir', type=str, default=r'H:\TCGA-GBM-2_cut')
parser.add_argument('--csv_path', type=str, default=r'E:\smu_meningoma_patch\pixibaoxing/pixibao_process_list_autogen.csv')
parser.add_argument('--feat_dir', type=str, default=r'G:\512_iamgenet_norm_2021_TCGA_patch_feature')  # 保存的路径
...
parser.add_argument('--checkpoint_path', type=str, default=r'E:\2021022219\lkycode\generate_feature\model_best_92.pth', help='the path of checkpoint')
...
if __name__ == '__main__':
	...
	for bag_name in os.listdir(args.data_dir):
		bag_path = os.path.join(args.data_dir, bag_name)
